    ...
    <div class="panel panel-default">
      ...
      <div class="alert alert-info" id="notify" <?php if (!isset($msg)) { ?>style="display: none;"<?php } ?>>
          ...
          <div class="form-group" id="existing_div">
            <label>Type of treatment<a href="#" data-tooltip="You can select existing treatment from your risk assessments, or you can create your own custom treatment"><img src="../img/help_ico.gif"/ class="help-ico"></a></label>
			...
			if ($edit) {
				...
				echo 'Create custom treatment';	
			}
			?>
            </option>
            <?php 
			  echo $treat->listAllTreatments($_SESSION["userid"]);
			?>
            </select>
           ...
           <div class="form-group">
            ...
            <input value="<?php if ($edit) echo $info["tre_treatment"];?>"  name="treatment" type="text" id="treatment" maxlength="255" class="form-control" placeholder="Enter treatment..." required>
         ...
         <div class="form-group">
           ...
           <div class="form-group">
            ...
            <input name="start" id="start" type="text" maxlength="20" class="form-control readonly" placeholder="Select start date..." required readonly style="cursor:pointer;" value="<?php if ($edit) { echo date("m/d/Y", strtotime($info["tre_start"])); } else { echo date("m/d/Y");}?>">
           
          </div>
     <div class="form-group">
            <label>Due date</label>
            <input name="due" id="due" type="text" maxlength="20" class="form-control readonly" placeholder="Select due date..." required readonly style="cursor:pointer;" value="<?php if ($edit) { echo date("m/d/Y", strtotime($info["tre_due"])); } else { echo date("m/d/Y");}?>">
