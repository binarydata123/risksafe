...
if ($_REQUEST["action"]=="editcriteria") {
	$edit=true;
	$id=$_REQUEST["id"];	
	$data=$audit->getCriteria($_REQUEST["id"]);
} else {
	$id=-1;
	$edit=false;	
}
    ...
    <div class="panel panel-default">
      ...
      <div class="alert alert-info" id="notify" <?php if (!isset($msg)) { ?>style="display: none;"<?php } ?>>
         ...
         <div class="form-group">
            ...
            <input name="question" type="text" maxlength="255" class="form-control" placeholder="Enter question..." required value="<?php if ($edit) echo $data["cri_question"];?>">
          
          </div>

          <div class="form-group">
            <label>Test Procedure</label>
            <input name="procedure" type="text" maxlength="255" class="form-control" placeholder="Enter test procedure..." required value="<?php if ($edit) echo $data["cri_procedure"];?>">
            ...
            <input name="expected" type="text" maxlength="255" class="form-control" placeholder="Enter expected outcome..." required value="<?php if ($edit) echo $data["cri_expected"];?>">
...
<option value="0" <?php if ($edit and $data["cri_outcome"]=="0") echo ' selected';?>>N/A</option>
<option value="1" <?php if ($edit and $data["cri_outcome"]=="1") echo ' selected';?>>Pass</option>
<option value="2" <?php if ($edit and $data["cri_outcome"]=="2") echo ' selected';?>>Fail</option>
</select>
 </div>
          <div class="form-group">
            <label>Notes</label>
            <textarea rows="4" name="notes" class="form-control"><?php if ($edit) echo $data["cri_notes"];?></textarea>
