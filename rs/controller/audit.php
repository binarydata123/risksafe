<?php
	...
	if (isset($_REQUEST["action"]) && $_REQUEST["action"]=="add") {
	  ...
	  if ($au=$audit->addAudit($_REQUEST["company"],$_REQUEST["industry"],$_REQUEST["team"],$_REQUEST["task"],$_REQUEST["assessor"],$_REQUEST["site"],$_REQUEST["date"],$_REQUEST["time"],$_REQUEST["street"],$_REQUEST["building"],$_REQUEST["zipcode"],$_REQUEST["state"],$_REQUEST["country"],$_REQUEST["control"])) {
	...
	if (isset($_REQUEST["action"]) && $_REQUEST["action"]=="edit") {
	  ...
	  if ($audit->editAudit($_REQUEST["id"],$_REQUEST["company"],$_REQUEST["industry"],$_REQUEST["team"],$_REQUEST["task"],$_REQUEST["assessor"],$_REQUEST["site"],$_REQUEST["date"],$_REQUEST["time"],$_REQUEST["street"],$_REQUEST["building"],$_REQUEST["zipcode"],$_REQUEST["state"],$_REQUEST["country"],$_REQUEST["control"])) {
