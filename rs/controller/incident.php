<?php
	...
	//ADD
	// $title, $date, $reported, $team, $descript, $impact, $priority, $status
	if (isset($_REQUEST["action"]) && $_REQUEST["action"]=="add") {		
	  if ($au=$incidents->addIncident($_REQUEST["title"],$_REQUEST["date"],$_REQUEST["reported"],$_REQUEST["team"],$_REQUEST["descript"],$_REQUEST["impact"],$_REQUEST["priority"],$_REQUEST["status"])) {
	...
	if (isset($_REQUEST["action"]) && $_REQUEST["action"]=="edit") {
	  ...
	  if ($incidents->editIncident($_REQUEST["id"],$_REQUEST["title"],$_REQUEST["date"],$_REQUEST["reported"],$_REQUEST["team"],$_REQUEST["descript"],$_REQUEST["impact"],$_REQUEST["priority"],$_REQUEST["status"])) {
	  	header("Location: ../view/incidents.php?response=success");	  				
	  } else {
