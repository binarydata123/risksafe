...
// not needed anymore
// if (isset($_REQUEST["id"])) $_SESSION["assessment"]=$_REQUEST["id"];
if(isset($_REQUEST['response']) && $_REQUEST['response'] == true){
	$msg = "Information saved successfully.";
}

$assess=new assessment();
$info=$assess->getAssessment($_SESSION["assessment"]);
      ...
      <div class="panel-body">
		   ...
		   <table width="100%" border="0" cellspacing="0" cellpadding="3">
		     ...
		     <tr>
		       ...
		       <td width="30%" height="30" align="left" valign="middle" class="content_text"><?php echo $info["idassessment"];?></td>
