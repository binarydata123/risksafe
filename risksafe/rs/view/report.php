...
if (isset($_REQUEST["action"]) && $_REQUEST["action"]=="downloadxls") {
  ...
  $col = PHPExcel_Cell::columnIndexFromString('A') - 1;
	$objPHPExcel->setActiveSheetIndex(0)-> setCellValueByColumnAndRow($col,$row, 'Chart');
				  
  $row = 7;
  $col = PHPExcel_Cell::columnIndexFromString('C') - 1;
	$objPHPExcel->setActiveSheetIndex(0)-> setCellValueByColumnAndRow($col,$row, 'Consequence');
...
$data=$report->getReport($_REQUEST["id"]);
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <form role="form" id="form" action="../view/report.php" method="post">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" name="action" value="downloadxls"
                                            class="btn btn-md btn-info pull-right" id="btn_save">Export to MS
                                            Excel</button>
                                    </div>
                                </form>
                                <!-- <button type="button" class="btn btn-md btn-info pull-right" id="btn_xls">Export to MS Excel</button> -->
                                <button style="margin-right:10px;" type="button" class="btn btn-md btn-info pull-right"
                                    id="btn_back">&lt;&lt; Back</button>
                            </div>
                            <div class="form-group">
                                <div class="title_text">Assessment number</div>
                                <div class="content_text"><?php echo $data["as_number"];?></div>
                            </div>
                            <div class="form-group">
                                <div class="title_text">Organisation or Team Name</div>
                                <div class="content_text"><?php echo $data["as_team"];?></div>
                            </div>

                            <div class="form-group">
                                <div class="title_text">Task or Process Being reviewed</div>
                                <div class="content_text"><?php echo $data["as_task"];?></div>
                            </div>

                            <div class="form-group">
                                <div class="title_text">Bussiness/Process Owner</div>
                                <div class="content_text"><?php echo $data["as_owner"];?></div>
                            </div>

                            <div class="form-group">
                                <div class="title_text">Assessor Name</div>
                                <div class="content_text"><?php echo $data["as_assessor"];?></div>
                            </div>
                            <div class="form-group">
                                <div class="title_text">Date</div>
                                <div class="content_text"><?php echo date("m/d/Y", strtotime($data["as_date"]));?></div>
                            </div>
                            <div class="form-group">
                                <div class="title_text">Next Assessment Date</div>
                                <div class="content_text"><?php echo date("m/d/Y", strtotime($data["as_next"]));?></div>
                            </div>
                            <div class="form-group">
				...
				echo $report->getApproval($data["as_approval"]);
                            ...
                            <div class="form-group">
                                ...
                                <div style="width:100%;height:auto;">
                                    <table width="100%" border="1" cellspacing="0" cellpadding="3">
                                        ...
                                        <tr>
                                            <td width="3%" rowspan="6" align="center" valign="middle"
                                                class="tbl_rotate"><strong>Likelihood</strong></td>
                                        ...
                                        <tr>
                                            ...
                                            <td width="12%" align="center" valign="middle">
                                                <strong><?php echo $totalrisks;?></strong></td>
                                        </tr>
                                    </table>
                                </div>
